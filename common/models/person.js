...
module.exports = function (Person) {
  ...
  Person.disableRemoteMethod('__create__emp', false);
  Person.disableRemoteMethod('__delete__emp', false);
  Person.disableRemoteMethod('__count__emp', false);
  Person.disableRemoteMethod('__findById__emp', false);
  Person.disableRemoteMethod('__updateById__emp', false);
  Person.disableRemoteMethod('__destroyById__emp', false);
